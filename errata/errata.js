	...
	function init() {
		...
		$("html").append('<div id="com-estudiocaravana-errata-boxWrapper">' +
				'<div id="com-estudiocaravana-errata-box">' +
					'<a id="com-estudiocaravana-errata-title" href="javascript:errata.showForm()">Aviso de error</a>' +
					'<div id="com-estudiocaravana-errata-form">' +
						'Error: <span id="com-estudiocaravana-errata-errata"></span>' +
						'<span id="com-estudiocaravana-errata-errata-error-noerrata" class="com-estudiocaravana-errata-error">Debe seleccionar un error</span>' +
						'<br>' +
						'Corrección:' +
					...
					'<div id="com-estudiocaravana-errata-status">' +
						...
						'<span id="com-estudiocaravana-errata-status-errataSent">¡Error enviado!</span>' +
					'</div>' +
				'</div>' +
			'</div>');
